...
const APP_I18N_LANGUAGES = ["en","pt","ga","lt","ru","uk","ro","es","bg","lv","ur"];
const DEFAULT_LANGUAGE = 'en';
const APP_LANGUAGE_SET = new Set(APP_I18N_LANGUAGES);

function detectLanguageFromAcceptLanguage(acceptLanguageHeader) {
...
export default getRequestConfig(async () => {
  ...
  const cookieLocale = cookieStore.get && cookieStore.get('NEXT_LOCALE')?.value;
